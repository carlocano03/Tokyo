  ...
  <div class="row no-gutters mp-mb4 justify-content-center">
    <div class="col-12 mp-ph2 mp-pv2">
      <div class="mp-ph4 mp-pv4 mp-card mp-card--plain">
        <input type="hidden" id="PEL_count" value="">
        <input type="hidden" id="BL_count" value="">
        <input type="hidden" id="EML_count" value="">
        <input type="hidden" id="CBL_count" value="">
        <input type="hidden" id="BTL_count" value="">
        <div align="center">
          <div class="mp-mb3 mp-text-fw-heavy">Total Member's Equity: &nbsp;&nbsp;&nbsp;&nbsp; PHP 10000</div>
       ...
       <div class="PEL DIV">
         ...
         <div id="bank_det" align="center">
          ...
          <div class="mp-mb3 mp-text-fw-heavy">Max PEL Loanable Amount: &nbsp;&nbsp;&nbsp;&nbsp; PHP 100000</div>
        </div>
        ...
        <div class="NEW PELDIV new-peldiv">
          ...
          <div class="flex-form"
           >
            ...
            <input type="number" onkeypress="return event.charCode >= 48 && event.charCode <= 57" id="amount" name="amount" style="width:30%;"  max="" required onkeypress="return isNumber(event)">
        ...
        <div class="row flex-form flex-form-margin" style="margin-top: 20px;">
          ...
          <input type="email" id="email" name="email" style="width:30%;"  value='' required >
       
        </div>
        <div class="row flex-form flex-form-margin" style="margin-top: 20px;">
          <label for="lname">Active Mobile Number: +63</label>
          <input type="text" value='' onkeypress="return event.charCode >= 48 && event.charCode <= 57" maxlength="10" id="c_number" name="c_number" style="width:30%;"  required onkeypress="return isNumber(event)">
      ...
      <div class="RENEWAL PELDIV new-peldiv">
        ...
        <div class="row flex-form flex-form-margin">
          <label for="lname">Active Email:</label>
          <input type="email" id="email" name="email" value='' style="width:30%;"  required >
         </div>
        <div class="row flex-form flex-form-margin" style="margin-top: 20px;">
          <label for="lname">Active Mobile Number: +63</label>
          <input type="text" onkeypress="return event.charCode >= 48 && event.charCode <= 57" maxlength="10" id="c_number" name="c_number" style="width:30%;"  value='' required onkeypress="return isNumber(event)">
        </div>
        <br>
