    ...
    <div class="col-lg-8 mp-pr0 mp-mt2 mp-mb4" id="beneficiariesDiv" style="width: 100%;">
      <div class="card-container card p-0">
        ...
        <div class="card-body justify-content-center gap-10 flex-row p-0 mp-ph2">
          <div class="container-fluid no-gutters black-clr">
            <div class="row">
              <div class="col-12  items-between flex-wrap d-flex">
                <span class="font-bold">Salary Grade: 1-5</span> <span class="font-sm">Vote Summary Count: 1</span>
              </div>
            </div>
            <div class="row mp-mb3">
              <div class="justify-content-center justify-items-center mp-pv3 cards-container">
                <div data-set="1" class="candidate card mp-mt4 justify-content-center justify-items-center d-flex align-content-center flex-column" style="width: 90%">
                  <div class="profile-img  justify-content-center justify-items-center d-flex align-content-center">
                    <img style="width: 100px; height: 100px;" src="https://scontent.fmnl4-2.fna.fbcdn.net/v/t39.30808-6/333703943_879550633256042_5999893648977274305_n.jpg?_nc_cat=105&amp;ccb=1-7&amp;_nc_sid=09cbfe&amp;_nc_eui2=AeEvDY9Oe-XZrHs-GDUojjSZgyayc5ndww6DJrJzmd3DDv3w58dPBBxi9TKP4f0RndihehBgfuodgKGh3phfTpJz&amp;_nc_ohc=Rala1y4s5KoAX_E8fm3&amp;_nc_ht=scontent.fmnl4-2.fna&amp;oh=00_AfA9i2OQ2TviYLFewh1RsM4Hl-kAgHga0VpODOgsRh1NtQ&amp;oe=640B1A9D" alt="">
                  </div>
                  <span class="mp-text-center font-bold mp-mt5">
                    Dela Cruz, Juan F.
                  </span>
                  <span class="mp-text-center font-sm">
                    2017-3123786
                  </span>
                  <span class="mp-text-center font-sm">
                    UP Diliman / Staff
                  </span>
                  <button class="up-button btn-md mp-text-center mp-mt4" id="view_profile" type="button">
                    <span>View Profile</span>
                  </button>
                </div>
                <div data-set="2" class="candidate card mp-mt4 justify-content-center justify-items-center d-flex align-content-center flex-column" style="width: 90%">
                  <div class="profile-img  justify-content-center justify-items-center d-flex align-content-center">
                    <img style="width: 100px; height: 100px;" src="https://scontent.fmnl4-2.fna.fbcdn.net/v/t39.30808-6/333703943_879550633256042_5999893648977274305_n.jpg?_nc_cat=105&amp;ccb=1-7&amp;_nc_sid=09cbfe&amp;_nc_eui2=AeEvDY9Oe-XZrHs-GDUojjSZgyayc5ndww6DJrJzmd3DDv3w58dPBBxi9TKP4f0RndihehBgfuodgKGh3phfTpJz&amp;_nc_ohc=Rala1y4s5KoAX_E8fm3&amp;_nc_ht=scontent.fmnl4-2.fna&amp;oh=00_AfA9i2OQ2TviYLFewh1RsM4Hl-kAgHga0VpODOgsRh1NtQ&amp;oe=640B1A9D" alt="">
                  </div>
                  <span class="mp-text-center font-bold mp-mt5">
                ...
                <div data-set="3" class="candidate card mp-mt4 justify-content-center justify-items-center d-flex align-content-center flex-column" style="width: 90%">
                  <div class="profile-img  justify-content-center justify-items-center d-flex align-content-center">
                    <img style="width: 100px; height: 100px;" src="https://scontent.fmnl4-2.fna.fbcdn.net/v/t39.30808-6/333703943_879550633256042_5999893648977274305_n.jpg?_nc_cat=105&amp;ccb=1-7&amp;_nc_sid=09cbfe&amp;_nc_eui2=AeEvDY9Oe-XZrHs-GDUojjSZgyayc5ndww6DJrJzmd3DDv3w58dPBBxi9TKP4f0RndihehBgfuodgKGh3phfTpJz&amp;_nc_ohc=Rala1y4s5KoAX_E8fm3&amp;_nc_ht=scontent.fmnl4-2.fna&amp;oh=00_AfA9i2OQ2TviYLFewh1RsM4Hl-kAgHga0VpODOgsRh1NtQ&amp;oe=640B1A9D" alt="">
                  </div>
                  <span class="mp-text-center font-bold mp-mt5">
                ...
                <div data-set="4" class="candidate card mp-mt4 justify-content-center justify-items-center d-flex align-content-center flex-column" style="width: 90%">
                  <div class="profile-img  justify-content-center justify-items-center d-flex align-content-center">
                    <img style="width: 100px; height: 100px;" src="https://scontent.fmnl4-2.fna.fbcdn.net/v/t39.30808-6/333703943_879550633256042_5999893648977274305_n.jpg?_nc_cat=105&amp;ccb=1-7&amp;_nc_sid=09cbfe&amp;_nc_eui2=AeEvDY9Oe-XZrHs-GDUojjSZgyayc5ndww6DJrJzmd3DDv3w58dPBBxi9TKP4f0RndihehBgfuodgKGh3phfTpJz&amp;_nc_ohc=Rala1y4s5KoAX_E8fm3&amp;_nc_ht=scontent.fmnl4-2.fna&amp;oh=00_AfA9i2OQ2TviYLFewh1RsM4Hl-kAgHga0VpODOgsRh1NtQ&amp;oe=640B1A9D" alt="">
                  </div>
                  <span class="mp-text-center font-bold mp-mt5">
            ...
            <div class="row mp-mb4">
              <div class="col-12 d-flex justify-content-center ">
                <button class="up-button btn-md mp-text-center mp-mt4 gray-bg color-white" id="view_profile" type="button">
                  <span>Abstain (Vote)</span>
                </button>
              </div>
              <div class="col-12 d-flex justify-content-center ">
                <button class="up-button btn-md mp-text-center mp-mt2 magenta-bg font-lg" id="view_profile" type="button">
...
<script>
  ...
  $(document).on('click','.candidate', function () {
    const value = $(this).attr('data-set')
    if($(this).hasClass('selected')) {
      $(this).removeClass('selected')
      return false
    }
    $('.candidate').map(function (){
