                    ...
                    <div class="settings-tab">
                        ...
                        <div class="settings-buttons">
                            <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-start" id="menu">
                                ...
                                <li class="options " onclick="location.href='/admin/benefit/benefit-matrix'">
                                    <a href="#" class="no-padding ">Benefit Matrix Details</a><br>

                                </li>
                                <li class="options options-active" onclick="location.href='/admin/benefit/benefit-list'">
                                    <a href="#" class="no-padding options-a-active">Benefit List</a><br>

                                </li>
                                <li class="options " onclick="location.href='/admin/benefit/benefit-analytics'">
                                    <a href="#" class="no-padding ">Benefit Analytics</a><br>
