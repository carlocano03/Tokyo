                    ...
                    <div class="settings-tab">
                        ...
                        <div class="settings-buttons">
                            <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-start" id="menu">
                                ...
                                <li class="options options-active" onclick="location.href='/admin/benefit/benefit-matrix'">
                                    <a href="#" class="no-padding options-a-active">Benefit Matrix Details</a><br>

                                </li>
                                <li class="options " onclick="location.href='/admin/benefit/benefit-list'">
                                    <a href="#" class="no-padding ">Benefit List</a><br>
