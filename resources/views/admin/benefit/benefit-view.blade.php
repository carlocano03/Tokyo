...
<div class="col-12 padding-content mp-text mp-text-c-accent dashboard mh-content">
  <div class="row">
    <div class="col-12 mp-pv4 mp-ph1">
      <a href="/admin/benefit/benefit-list" class="up-button btn-md button-animate-left mp-text-center" id="view_profile" type="button">
        <span>Back</span>
      </a>
    </div>
  </div>
    ...
    <div class="col-lg-8 mp-pr0 mp-mt2 mp-mb4" id="beneficiariesDiv" style="width: 100%;">
      ...
      <div class="mp-card mp-p4 h-auto font-xs color-black" style="padding:20px;">
        <div class="container-fluid">
          ...
          <div class="row mp-mh2 mp-mt5">
            <div class="col-12">

              <div class="row justify-content-center" style="gap: 30px;">
                <button style="border-radius: 8px" class="font-bold font-md color-white gray-bg mp-ph1 mp-pv4 ">DISAPPROVE CLAIM</button>
                <button style="border-radius: 8px" class="font-bold font-md color-white maroon-bg mp-ph1 mp-pv4 ">APPROVE CLAIM</button>
              </div>
            </div>
          </div>
        </div>
