...
<div class="row no-gutter ml-0 mr-0 p-5px mh-content" id="view-member-details">
    ...
    <div class="w-full">
        <div class="card relative" style="min-height: 200px;">
            ...
            <div class="card-container card p-0 mp-mt3 border-bottom-0">
...
<script>
    ...
    $(document).on('click', '.header-tabs > span', function(e) {
        ...
        window.location.href = '/admin/members/records/view/hrdo' + links[dataSet] + '/' + id
    })
