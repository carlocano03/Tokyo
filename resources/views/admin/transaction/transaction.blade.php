                    ...
                    <div class="settings-tab">
                        ...
                        <div class="settings-buttons">
                            <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-start" id="menu">
                                ...
                                <li class="options options-active" onclick="location.href='/admin/transaction'">
                                    <a href="#" class="no-padding options-a-active">Monthly Contributions</a><br>

                                </li>
                                <li class="options " onclick="location.href='/admin/transaction/loan-payment'">
                                    <a href="#" class="no-padding ">Loans Payment</a><br>
